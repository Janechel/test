...
#define ServoPrintf Serial           //A serial port for output information.
#define PRINTF_ENABLE 1              //Print output enable.
#define MAX_SERVERS 6               //Maximum number of servos for sync write.

#if PRINTF_ENABLE
#define PRINTF(...) ServoPrintf.print(__VA_ARGS__)
#else
#define PRINTF(...)
#endif
